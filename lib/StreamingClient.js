...
function StreamingClient(config) {
  ...
  this.windowSlide       = config.windowSlide;
...
StreamingClient.prototype.run = function(callback) {
  ...
  var streamer = new Streamer(ldf, this.target, this.originalVariables, this.durationCallback, type, this.windowSlide, this.singleQuery);
  var self = this;

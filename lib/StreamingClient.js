...
function StreamingClient(config) {
  ...
  this.periodicity       = config.periodicity;
  this.singleQuery       = config.singleQuery;
}

StreamingClient.prototype.run = function(callback) {
  var rewriter = new Rewriter(ldf, type, this.target, this._cachingEnabled);
  var streamer = new Streamer(ldf, this.target, this.originalVariables, this.durationCallback, type, this.periodicity, this.singleQuery);
  var self = this;
